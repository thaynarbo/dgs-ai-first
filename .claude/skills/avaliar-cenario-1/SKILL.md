---
name: avaliar-cenario-1
description: 'Avalia a entrega de um desenvolvedor no Cenário 1 da Trilha de Certificação AI First (exercícios 1.1, 1.2, 1.3). Use quando precisar avaliar ou revisar entregas do Cenário-Âncora 1.'
---
...
> **Referência:** Usar com a skill `/avaliacao-foundation` para dimensões e escala.
